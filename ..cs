...
[BepInPlugin(".AVFX_Options..", "AV Effect Options", "1.1.0")]
...
public sealed class _: BaseUnityPlugin {  
  ...
  private void Awake() {
    ...
    ᚭᛣᛮᛨᚶᛟᚷᚴ("ExplodeOnDeath/WilloWispExplosion", "Enable Will-o-the-Wisp", "Enables the Will o' the Wisp explosion");
  }
